      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {blogPosts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <h2 className="text-2xl font-bold mb-2 text-purple-400">Chưa có bài viết nào</h2>
            ...
            {/* <Button
              className="bg-gradient-to-r from-purple-400 to-purple-600 text-black font-bold px-6 py-3 rounded-3xl shadow-lg hover:scale-105 transition-all duration-300 border-2 border-purple-400 flex items-center gap-2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <div
                key={post.slug}
                className="bg-black/70 border border-purple-500/30 rounded-xl p-6 shadow-lg flex flex-col justify-between hover:border-purple-400 transition-all duration-200"
              >
                <div>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-purple-400 to-purple-600 text-black font-bold px-4 py-2 rounded-2xl shadow hover:scale-105 transition-all duration-200 border border-purple-400 flex items-center gap-2"
