      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        {blogPosts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24">
            ...
            {/* <Button
              className="bg-gradient-to-r from-green-400 to-green-600 text-black font-bold px-6 py-3 rounded-3xl shadow-lg hover:scale-105 transition-all duration-300 border-2 border-green-400 flex items-center gap-2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.map((post) => (
              <div
                key={post.slug}
                className="bg-black/70 border border-green-500/30 rounded-xl p-6 shadow-lg flex flex-col justify-between hover:border-green-400 transition-all duration-200"
              >
                <div>
                  <h3 className="text-xl font-bold text-green-400 mb-2">{post.title}</h3>
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <Button
                    size="sm"
                    className="bg-gradient-to-r from-green-400 to-green-600 text-black font-bold px-4 py-2 rounded-2xl shadow hover:scale-105 transition-all duration-200 border border-green-400 flex items-center gap-2"
