...
const overviewFeatures = [
  { icon: <Shield className="w-5 h-5 text-green-400" />, text: "Kiểm toán smart contracts" },
  { icon: <Lock className="w-5 h-5 text-green-400" />, text: "Xác thực đa yếu tố" },
  { icon: <Shield className="w-5 h-5 text-green-400" />, text: "Mã hóa đầu cuối" },
  { icon: <Shield className="w-5 h-5 text-green-400" />, text: "Giám sát giao dịch 24/7" },
  { icon: <Shield className="w-5 h-5 text-green-400" />, text: "Bảo vệ chống tấn công DDoS" },
]
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-green-400 flex items-center gap-2">
            <Shield className="w-6 h-6 text-green-400" /> Tổng quan về bảo mật
          </h2>
        ...
        {/* Bảo mật tài khoản */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-green-400">Bảo mật tài khoản</h2>
        ...
        {/* Bảo mật giao dịch */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-4 text-green-400">Bảo mật giao dịch</h2>
          <div className="space-y-3">
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-bold mb-4 text-green-400">Quy trình xử lý sự cố</h2>
          <div className="space-y-3">
