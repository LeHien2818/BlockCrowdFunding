...
export default function FeaturesPage() {
  ...
  const features = [
    ...
    {
      icon: <ChartBar className="w-6 h-6 text-green-400" />,
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center space-y-6 mb-16">
          ...
          <h2 className="text-xl md:text-2xl font-semibold text-green-500 mb-3">Platform Features</h2>
        ...
        <div className="mt-16 text-center">
          <Button 
            ...
            className="bg-green-500 hover:bg-green-600 text-black font-bold px-8 py-6 text-lg transition-all duration-300 hover:scale-105"
          >
            Bắt Đầu Ngay
