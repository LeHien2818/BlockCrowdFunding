...
const FeatureCard = ({ icon, title, description }: FeatureCardProps) => {
  ...
  return (
    <div
      className={`relative z-0 bg-black/40 border border-green-500/20 rounded-xl p-6 overflow-hidden transition-all duration-300 ${
        isHovered ? "transform scale-[1.02] shadow-lg shadow-green-500/10" : ""
      }`}
    ...
    >
      ...
      <div className="relative z-10">
        <div className="bg-green-500/10 rounded-lg p-3 w-12 h-12 flex items-center justify-center mb-4">
          {icon}
        </div>
...
const Feature = () => {
  ...
  return (
    <main className="min-h-screen bg-black text-white flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 border-b-[1px] border-green-500/20 border-t-[1px] border-green-500/20">
      <div className="max-w-7xl w-full">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-2 bg-gradient-to-r from-green-400 to-green-600 bg-clip-text text-white ">
          Revolutionary Features
        </h1>
        <h2 className="text-xl md:text-2xl font-semibold text-center mb-3 text-green-400">
          Platform Features
        </h2>
